...
const AuthLayout = ({ children, showBack = false, onBack }) => (
  <div className="min-h-screen flex flex-col bg-primary-white w-full max-w-[1296px] mx-auto px-4">
    ...
    <main className="flex-1 pb-8">
      <div className=" flex flex-col overflow-hidden bg-primary-white md:flex-row gap-10">
        <div className="relative mx-auto w-full max-w-[400px] lg:max-w-[450px] xl:max-w-[500px] shrink-0 md:mx-0 md:min-h-[540px] max-base:hidden">
          <img
